...
extension MatchPlayer {
	static let colors = [
		Color(code: "#C70000"), Color(code: "#4353FF"), Color(code: "#C9C700"),
		Color(code: "#019327"), Color(code: "#B4065D"), Color(code: "#FF7F00"),
		Color(code: "#009597"), Color(code: "#934200"),
	]
	static let borderColors = [
		Color(code: "#FF3C3C"), Color(code: "#5080FF"), Color(code: "#FFFC17"),
		Color(code: "#00ff42"), Color(code: "#F660AB"), Color(code: "#FFA200"),
		Color(code: "#00FCFF"), Color(code: "#A9651C"),
	]
